...
struct card_stack ** base_set() {
    ...
    int witch_instr[] = {PLUS_CARD, PLUS_CARD, EACH_OTHER_PLAYER_GAINS_A_CURSE};
    ...
    int workshop_instr[] = {GAIN_A_CARD_COSTING_UP_TO_FOUR};
    ...
    int bandit_instr[] = {GAIN_A_GOLD};
    int council_room_instr[] = {PLUS_CARD, PLUS_CARD, PLUS_CARD, PLUS_CARD, PLUS_BUY, EACH_OTHER_PLAYER_DRAWS_A_CARD};
